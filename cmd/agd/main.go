...
Usage:
  ...
  agd code-plan-check [root] [--mode auto|git|cache] [--git-source staged|worktree] [--cache <file>] [--scope-policy <file>] [--relation-policy <file>] [--strict-mapping] [--strict-relation]
